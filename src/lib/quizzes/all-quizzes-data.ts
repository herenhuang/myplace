...
export const ALL_QUIZZES: QuizItem[] = [
  // LOVE QUIZZES
  {
    ...
    backgroundImage: 'linear-gradient(135deg, #ff6b9d 0%, #c06c84 50%, #f67280 100%)'
  },
  {
    id: 'flirting-style',
    ...
    backgroundImage: 'linear-gradient(135deg, #ff758c 0%, #ff7eb3 50%, #fa709a 100%)'
  },
  {
    id: 'how-do-you-fall',
    ...
    backgroundImage: 'linear-gradient(135deg, #fa709a 0%, #fee140 50%, #ffa07a 100%)'
  },
  {
    ...
    backgroundImage: 'linear-gradient(135deg, #f093fb 0%, #f5576c 50%, #ff9a9e 100%)'
  },
  {
    ...
    backgroundImage: 'linear-gradient(135deg, #ffecd2 0%, #fcb69f 50%, #ff9a9e 100%)'
  },
  {
    ...
    backgroundImage: 'linear-gradient(135deg, #ffd1ff 0%, #ff9a9e 50%, #fecfef 100%)'
  },
  ...
  },
  {
    ...
    category: 'work',
    route: '/quiz/ai-model',
    backgroundImage: 'linear-gradient(135deg, #ff6b35 0%, #ffa500 50%, #ffcc70 100%)'
  },
  {
    ...
    backgroundImage: 'linear-gradient(135deg, #fa8bff 0%, #2bd2ff 50%, #2bff88 100%)'
  },
  {
    ...
    backgroundImage: 'linear-gradient(135deg, #a8edea 0%, #fed6e3 50%, #fbc2eb 100%)'
  },
  {
    ...
    backgroundImage: 'linear-gradient(135deg, #ffecd2 0%, #fcb69f 50%, #a8edea 100%)'
  },
  {
    id: 'elevate',
  ...
  // LIFE QUIZZES
  {
    ...
    backgroundImage: 'linear-gradient(135deg, #fbc2eb 0%, #a6c1ee 50%, #c2e9fb 100%)'
  },
  {
    id: 'genshin',
